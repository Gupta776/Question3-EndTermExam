	...
	public static void main(String[] args) {
		...
		switch (select) {
			case 1:
				...
				System.out.println("Your bill amount is Rs. " +purchasedAmt +". Congrats! As you are a Privileged" +
						" customer, you are eligible for a" +"\n"+"discount!");
				System.out.println("You will have to pay Rs. "+cust.getBillAmount(purchasedAmt));
				break;
			case 2:
				takeInput();
				...
				System.out.println("Your bill amount is Rs. " +purchasedAmt +". Congrats! As you are a Senior" +
						" Citizen, you are eligible for a" +"\n"+"discount!");
				System.out.println("You will have to pay Rs. "+cust1.getBillAmount(purchasedAmt));
				break;
